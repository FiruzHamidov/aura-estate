...
class ReelController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'poster_second' => 'nullable|integer|min:0|max:60',
            'duration' => 'nullable|integer|min:0|max:60',
    ...
    public function update(Request $request, Reel $reel): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'poster_second' => 'sometimes|nullable|integer|min:0|max:60',
            'duration' => 'sometimes|nullable|integer|min:0|max:60',
