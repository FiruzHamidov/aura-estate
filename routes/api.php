...
use App\Http\Controllers\PropertyControlReportController;
...
Route::middleware(['auth:sanctum', 'active.user', 'daily.report'])->group(function () {
    ...
    Route::get('/kpi/rop-plans', [KpiRopPlanController::class, 'index'])->middleware('rop.branch.scope');
    Route::get('/kpi/rop-plans/{id}', [KpiRopPlanController::class, 'show'])->middleware('rop.branch.scope');
    Route::post('/kpi/rop-plans', [KpiRopPlanController::class, 'store'])->middleware('rop.branch.scope');
    Route::patch('/kpi/rop-plans/{id}', [KpiRopPlanController::class, 'update'])->middleware('rop.branch.scope');
    Route::post('/kpi/rop-plans/{id}/copy', [KpiRopPlanController::class, 'copy'])->middleware('rop.branch.scope');
    ...
    Route::put('/crm/tasks/{crmTask}', [CrmTaskController::class, 'update'])->middleware('rop.branch.scope');
    Route::patch('/crm/tasks/{crmTask}', [CrmTaskController::class, 'update'])->middleware('rop.branch.scope');
    Route::post('/kpi-period-locks', [KpiPeriodLockController::class, 'lock'])->middleware('rop.branch.scope');
    ...
    Route::patch('/kpi/telegram-reports/config', [KpiModuleController::class, 'updateTelegramConfig'])->middleware('rop.branch.scope');
    Route::get('/kpi/ops/telegram/config', [KpiModuleController::class, 'telegramConfig'])->middleware('rop.branch.scope');
    Route::patch('/kpi/ops/telegram/config', [KpiModuleController::class, 'updateTelegramConfig'])->middleware('rop.branch.scope');
    Route::get('/kpi/quality/issues', [KpiModuleController::class, 'qualityIssues'])->middleware('rop.branch.scope');
    Route::get('/kpi/ops/quality/issues', [KpiModuleController::class, 'qualityIssues'])->middleware('rop.branch.scope');
    Route::get('/kpi/early-risk-alerts', [KpiModuleController::class, 'earlyRiskAlerts'])->middleware('rop.branch.scope');
    Route::get('/kpi/ops/early-risk-alerts', [KpiModuleController::class, 'earlyRiskAlerts'])->middleware('rop.branch.scope');
    Route::patch('/kpi/early-risk-alerts/status', [KpiModuleController::class, 'updateEarlyRiskStatus'])->middleware('rop.branch.scope');
    Route::patch('/kpi/ops/early-risk-alerts/status', [KpiModuleController::class, 'updateEarlyRiskStatus'])->middleware('rop.branch.scope');
    Route::get('/kpi/period-contract', [KpiModuleController::class, 'periodContract'])->middleware('rop.branch.scope');
    Route::get('/kpi/ops/period-contract', [KpiModuleController::class, 'periodContract'])->middleware('rop.branch.scope');
    Route::get('/kpi/acceptance-runs', [KpiModuleController::class, 'acceptanceRuns'])->middleware('rop.branch.scope');
    Route::get('/kpi/ops/acceptance-runs', [KpiModuleController::class, 'acceptanceRuns'])->middleware('rop.branch.scope');
    ...
    Route::middleware('non.client')->group(function () {
        ...
        Route::post('/properties/{property}/promotion-settings', [\App\Http\Controllers\PropertyModerationController::class, 'setPromotion'])->middleware('moderation.idempotent')->middleware('moderation.payload');
        ...
        Route::post('/deals/{deal}/claim', [DealController::class, 'claim']);
        Route::apiResource('deals', DealController::class)->middleware('rop.branch.scope');
        Route::get('/crm/property-control/report', [PropertyControlReportController::class, 'summary']);
        Route::get('/crm/property-control/export', [PropertyControlReportController::class, 'export']);
        Route::get('/crm/property-control/meta', [PropertyControlReportController::class, 'meta']);
