...
Route::middleware(['auth:sanctum', 'active.user', 'daily.report'])->group(function () {
    ...
    Route::post('/kpi-adjustments', [KpiPeriodLockController::class, 'adjustments'])->middleware('rop.branch.scope');
    Route::get('/kpi-adjustments', [KpiPeriodLockController::class, 'adjustmentHistory'])->middleware('rop.branch.scope');
