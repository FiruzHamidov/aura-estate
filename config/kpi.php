    ...
    'v2' => [
        ...
        'metric_mapping' => [
            ...
            'ads' => [
                ...
                'source_type' => 'mixed',
                'mixed_strategy' => 'system_priority',
                'entities' => ['crm_tasks.completed_at', 'daily_reports.ad_count'],
                'valid_statuses' => ['done'],
                'task_type_codes' => ['AD_PUBLICATION', 'AD_CREATE'],
            ],
            'calls' => [
                'source_column' => 'calls_count',
                'source_type' => 'mixed',
                'mixed_strategy' => 'system_priority',
                'entities' => ['crm_tasks.completed_at', 'daily_reports.calls_count'],
                'valid_statuses' => ['done'],
