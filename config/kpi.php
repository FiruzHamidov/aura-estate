    ...
    'v2' => [
        ...
        'metric_mapping' => [
            ...
            'call' => [
                ...
                'source_type' => 'system',
                'entities' => ['crm_tasks', 'crm_task_types'],
                'valid_statuses' => ['done'],
                'task_type_codes' => ['CALL'],
            ],
            'kabul' => [
            ...
            'show' => [
                ...
                'source_type' => 'system',
                'entities' => ['bookings', 'crm_tasks', 'crm_task_types'],
                'valid_statuses' => ['done'],
                'task_type_codes' => ['SHOWING_COMPLETE'],
            ],
            'lead' => [
                'source_column' => 'meetings_count',
                'source_type' => 'manual',
                'entities' => ['daily_reports.meetings_count'],
                'valid_statuses' => [],
                'task_type_codes' => [],
            ],
            'deposit' => [
            ...
            'deal' => [
                ...
                'source_type' => 'system',
                'entities' => ['properties'],
                'valid_statuses' => ['sold', 'rented', 'sold_by_owner'],
                'task_type_codes' => [],
            ],
        ],
        'targets' => [
